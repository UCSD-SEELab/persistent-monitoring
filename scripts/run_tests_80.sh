...
list_cond=( "--B 10 --vmax 10 --amax 30 --Ntests 10 --Nq 80" \
            "--B 10 --vmax 20 --amax 30 --Ntests 10 --Nq 80" \
            "--B 10 --vmax 30 --amax 30 --Ntests 10 --Nq 80" \
            "--B 10 --vmax 10 --amax 10 --Ntests 10 --Nq 80" \
            "--B 10 --vmax 20 --amax 10 --Ntests 10 --Nq 80" \
            "--B 10 --vmax 30 --amax 10 --Ntests 10 --Nq 80" )
